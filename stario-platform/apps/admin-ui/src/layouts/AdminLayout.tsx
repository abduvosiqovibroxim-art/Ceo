...
const navigation = [
  ...
  { name: 'Artists', href: '/artists', icon: SparklesIcon },
  { name: 'Users', href: '/users', icon: UsersIcon },
  { name: 'Orders', href: '/orders', icon: ShoppingCartIcon },
  { name: 'Payments', href: '/payments', icon: CreditCardIcon },
  { name: 'Moderation', href: '/moderation', icon: ShieldCheckIcon },
  { name: 'Merchandise', href: '/merch', icon: ShoppingBagIcon },
      ...
      >
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-gray-900">
          <div className="flex h-16 items-center justify-between px-4">
            <span className="text-xl font-bold text-white">Stario Admin</span>
            <button
              onClick={() => setSidebarOpen(false)}
