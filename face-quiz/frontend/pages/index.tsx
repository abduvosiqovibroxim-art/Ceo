    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <div className="absolute top-4 right-4 flex gap-2">
        <button
          ...
          className={`px-3 py-1 rounded-full text-sm font-bold transition-all ${
            lang === 'uz' ? 'bg-purple-600 text-white' : 'bg-white/20 text-white hover:bg-white/30'
          }`}
        >
          UZ
        </button>
        <button
          onClick={() => setLang('ru')}
          className={`px-3 py-1 rounded-full text-sm font-bold transition-all ${
            lang === 'ru' ? 'bg-purple-600 text-white' : 'bg-white/20 text-white hover:bg-white/30'
          }`}
        >
          RU
        </button>
        <button
          onClick={() => setLang('en')}
          className={`px-3 py-1 rounded-full text-sm font-bold transition-all ${
            lang === 'en' ? 'bg-purple-600 text-white' : 'bg-white/20 text-white hover:bg-white/30'
          }`}
        >
          EN
        </button>
      ...
      {state === 'choose' && (
        <div className="flex flex-col items-center gap-6">
          <div className="w-48 h-48 rounded-full bg-gradient-to-br from-purple-600 to-pink-600 flex items-center justify-center mb-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              ...
              className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold py-4 px-8 rounded-full text-xl shadow-lg transition-all transform hover:scale-105 flex items-center gap-3"
            >
            ...
            <label className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-bold py-4 px-8 rounded-full text-xl shadow-lg transition-all transform hover:scale-105 cursor-pointer flex items-center gap-3">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex gap-4">
            <button
              ...
              className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold py-4 px-8 rounded-full text-xl shadow-lg transition-all transform hover:scale-105"
            >
              {t.capture}
            </button>
            ...
            <button
              ...
              className="bg-gray-600 hover:bg-gray-700 text-white font-bold py-4 px-8 rounded-full text-xl shadow-lg transition-all"
            >
              {t.back}
            </button>
          </div>
      ...
      {state === 'loading' && (
        <div className="flex flex-col items-center gap-4">
          {previewImage && (
            <img src={previewImage} alt="Preview" className="w-48 h-48 rounded-2xl object-cover mb-4" />
          )}
      ...
      {state === 'results' && (
        <div className="flex flex-col items-center gap-6 w-full max-w-2xl">
          {previewImage && (
            <img src={previewImage} alt="Your photo" className="w-32 h-32 rounded-full object-cover border-4 border-purple-500" />
          )}
